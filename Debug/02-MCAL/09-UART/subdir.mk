...
C_SRCS += \
../02-MCAL/09-UART/UART_program.c 

OBJS += \
./02-MCAL/09-UART/UART_program.o 

C_DEPS += \
./02-MCAL/09-UART/UART_program.d 


# Each subdirectory must supply rules for building sources it contributes
02-MCAL/09-UART/%.o 02-MCAL/09-UART/%.su 02-MCAL/09-UART/%.cyclo: ../02-MCAL/09-UART/%.c 02-MCAL/09-UART/subdir.mk
...
clean: clean-02-2d-MCAL-2f-09-2d-UART

clean-02-2d-MCAL-2f-09-2d-UART:
	-$(RM) ./02-MCAL/09-UART/UART_program.cyclo ./02-MCAL/09-UART/UART_program.d ./02-MCAL/09-UART/UART_program.o ./02-MCAL/09-UART/UART_program.su

.PHONY: clean-02-2d-MCAL-2f-09-2d-UART
