...
C_SRCS += \
../02-MCAL/03-NVIC/NVIC_program.c 

OBJS += \
./02-MCAL/03-NVIC/NVIC_program.o 

C_DEPS += \
./02-MCAL/03-NVIC/NVIC_program.d 


# Each subdirectory must supply rules for building sources it contributes
02-MCAL/03-NVIC/%.o 02-MCAL/03-NVIC/%.su 02-MCAL/03-NVIC/%.cyclo: ../02-MCAL/03-NVIC/%.c 02-MCAL/03-NVIC/subdir.mk
...
clean: clean-02-2d-MCAL-2f-03-2d-NVIC

clean-02-2d-MCAL-2f-03-2d-NVIC:
	-$(RM) ./02-MCAL/03-NVIC/NVIC_program.cyclo ./02-MCAL/03-NVIC/NVIC_program.d ./02-MCAL/03-NVIC/NVIC_program.o ./02-MCAL/03-NVIC/NVIC_program.su

.PHONY: clean-02-2d-MCAL-2f-03-2d-NVIC
