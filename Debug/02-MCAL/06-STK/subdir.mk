...
C_SRCS += \
../02-MCAL/06-STK/STK_program.c 

OBJS += \
./02-MCAL/06-STK/STK_program.o 

C_DEPS += \
./02-MCAL/06-STK/STK_program.d 


# Each subdirectory must supply rules for building sources it contributes
02-MCAL/06-STK/%.o 02-MCAL/06-STK/%.su 02-MCAL/06-STK/%.cyclo: ../02-MCAL/06-STK/%.c 02-MCAL/06-STK/subdir.mk
...
clean: clean-02-2d-MCAL-2f-06-2d-STK

clean-02-2d-MCAL-2f-06-2d-STK:
	-$(RM) ./02-MCAL/06-STK/STK_program.cyclo ./02-MCAL/06-STK/STK_program.d ./02-MCAL/06-STK/STK_program.o ./02-MCAL/06-STK/STK_program.su

.PHONY: clean-02-2d-MCAL-2f-06-2d-STK
