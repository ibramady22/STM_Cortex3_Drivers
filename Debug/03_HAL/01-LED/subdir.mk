...
C_SRCS += \
../03_HAL/01-LED/LED_program.c 

OBJS += \
./03_HAL/01-LED/LED_program.o 

C_DEPS += \
./03_HAL/01-LED/LED_program.d 


# Each subdirectory must supply rules for building sources it contributes
03_HAL/01-LED/%.o 03_HAL/01-LED/%.su 03_HAL/01-LED/%.cyclo: ../03_HAL/01-LED/%.c 03_HAL/01-LED/subdir.mk
...
clean: clean-03_HAL-2f-01-2d-LED

clean-03_HAL-2f-01-2d-LED:
	-$(RM) ./03_HAL/01-LED/LED_program.cyclo ./03_HAL/01-LED/LED_program.d ./03_HAL/01-LED/LED_program.o ./03_HAL/01-LED/LED_program.su

.PHONY: clean-03_HAL-2f-01-2d-LED
