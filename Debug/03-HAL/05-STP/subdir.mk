...
C_SRCS += \
../03-HAL/05-STP/STP_program.c 

OBJS += \
./03-HAL/05-STP/STP_program.o 

C_DEPS += \
./03-HAL/05-STP/STP_program.d 


# Each subdirectory must supply rules for building sources it contributes
03-HAL/05-STP/%.o 03-HAL/05-STP/%.su 03-HAL/05-STP/%.cyclo: ../03-HAL/05-STP/%.c 03-HAL/05-STP/subdir.mk
...
clean: clean-03-2d-HAL-2f-05-2d-STP

clean-03-2d-HAL-2f-05-2d-STP:
	-$(RM) ./03-HAL/05-STP/STP_program.cyclo ./03-HAL/05-STP/STP_program.d ./03-HAL/05-STP/STP_program.o ./03-HAL/05-STP/STP_program.su

.PHONY: clean-03-2d-HAL-2f-05-2d-STP
