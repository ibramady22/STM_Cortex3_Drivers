...
03-HAL/01-LED/%.o 03-HAL/01-LED/%.su 03-HAL/01-LED/%.cyclo: ../03-HAL/01-LED/%.c 03-HAL/01-LED/subdir.mk
...
clean: clean-03-2d-HAL-2f-01-2d-LED

clean-03-2d-HAL-2f-01-2d-LED:
	-$(RM) ./03-HAL/01-LED/LED_program.cyclo ./03-HAL/01-LED/LED_program.d ./03-HAL/01-LED/LED_program.o ./03-HAL/01-LED/LED_program.su

.PHONY: clean-03-2d-HAL-2f-01-2d-LED
